    ...
    <section className="min-h-screen flex items-center justify-center p-6 bg-gray-50">
      <div className="flex flex-col md:flex-row items-center justify-center max-w-5xl mx-auto">
        ...
        <div className="flex justify-center w-full md:w-1/2">
          <figure className="flex justify-center">
            <img
              src={Profile}
              alt="Darshit Shah"
              className="w-48 h-48 md:w-64 md:h-64 rounded-full border-4 border-gray-200 dark:border-gray-700 shadow-lg object-cover"
              onError={(e) =>
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left w-full md:w-1/2 space-y-4">
          <h1 className="font-bold text-3xl md:text-4xl text-dark dark:text-light">
            Darshit Shah
          </h1>
